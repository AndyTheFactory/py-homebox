"""Pydantic models for Homebox label resource DTOs."""
...
class Label(BaseModel):
    """Internal ORM entity representing a Homebox label."""
...
class LabelEdges(BaseModel):
    """Graph edges for the Label ORM entity."""
...
class LabelCreate(BaseModel):
    """Request payload for creating a new label."""
...
class LabelOut(BaseModel):
    """API DTO for a label returned by label endpoints."""
