"""Pydantic models for Homebox tag resource DTOs."""
...
class Tag(BaseModel):
    """Internal ORM entity representing a Homebox tag."""
...
class TagEdges(BaseModel):
    """Graph edges for the Tag ORM entity."""
...
class TagOut(BaseModel):
    """API DTO for a tag returned by tag endpoints."""
