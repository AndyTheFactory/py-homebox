"""Pydantic models for Homebox notifier resource DTOs."""
...
class Notifier(BaseModel):
    """Internal ORM entity representing a Homebox notification channel."""
...
class NotifierEdges(BaseModel):
    """Graph edges for the Notifier ORM entity."""
...
class NotifierCreate(BaseModel):
    """Request payload for creating a new notification channel."""
...
class NotifierOut(BaseModel):
    """API DTO for a notifier returned by notification endpoints."""
...
class NotifierUpdate(BaseModel):
    """Request payload for updating an existing notification channel."""
