...
class ActionsClient:
    ...
    def create_missing_thumbnails(self) -> models.ActionAmountResult:
        return models.ActionAmountResult(
            **self.client._request("post", "/v1/actions/create-missing-thumbnails")
        )

    def ensure_asset_ids(self) -> models.ActionAmountResult:
        return models.ActionAmountResult(
            **self.client._request("post", "/v1/actions/ensure-asset-ids")
        )

    def ensure_import_refs(self) -> models.ActionAmountResult:
        return models.ActionAmountResult(
            **self.client._request("post", "/v1/actions/ensure-import-refs")
        )

    def set_primary_photos(self) -> models.ActionAmountResult:
        return models.ActionAmountResult(
            **self.client._request("post", "/v1/actions/set-primary-photos")
        )

    def zero_out_time_fields(self) -> models.ActionAmountResult:
        return models.ActionAmountResult(
            **self.client._request("post", "/v1/actions/zero-item-time-fields")
        )
...
class AssetsClient:
    ...
    def get_item_by_asset_id(self, id: str) -> models.PaginationResultRepoItemSummary:
        return models.PaginationResultRepoItemSummary(
            **self.client._request("get", f"/v1/assets/{id}")
        )
...
class GroupsClient:
    ...
    def get_label_statistics(self) -> list[models.TotalsByOrganizer]:
        return [
            models.TotalsByOrganizer(**item)
            for item in self.client._request("get", "/v1/groups/statistics/labels")
        ]

    def get_location_statistics(self) -> list[models.TotalsByOrganizer]:
        return [
            models.TotalsByOrganizer(**item)
            for item in self.client._request("get", "/v1/groups/statistics/locations")
        ]

    def get_purchase_price_statistics(
        self, start: str = None, end: str = None
    ) -> models.ValueOverTime:
        params = {}
        if start:
            params["start"] = start
        if end:
...
class ItemsClient:
    ...
    def query_all_items(
        ...
        return models.PaginationResultRepoItemSummary(
            **self.client._request("get", "/v1/items", params=params)
        )
    ...
    def update_item_attachment(
        self, id: str, attachment_id: str, data: models.ItemAttachmentUpdate
    ) -> models.ItemOut:
        return models.ItemOut(
            **self.client._request(
                "put", f"/v1/items/{id}/attachments/{attachment_id}", data=data.dict()
            )
        )
    ...
    def get_maintenance_log(
        self, id: str, status: types.MaintenanceFilterStatus = None
...
class LocationsClient:
    ...
    def get_all_locations(
        ...
        return [
            models.LocationOutCount(**item)
            for item in self.client._request("get", "/v1/locations", params=params)
        ]

    def create_location(self, data: models.LocationCreate) -> models.LocationSummary:
        return models.LocationSummary(
            **self.client._request("post", "/v1/locations", data=data.dict())
        )

    def get_locations_tree(self, withItems: bool = None) -> list[models.TreeItem]:
        params = {}
        if withItems:
            params["withItems"] = withItems
        return [
            models.TreeItem(**item)
            for item in self.client._request("get", "/v1/locations/tree", params=params)
        ]
...
class MaintenanceClient:
    ...
    def query_all_maintenance(
        self, status: types.MaintenanceFilterStatus = None
    ) -> list[models.MaintenanceEntryWithDetails]:
        params = {}
        if status:
            params["status"] = status.value
    ...
    def update_maintenance_entry(
        self, id: str, data: models.MaintenanceEntryUpdate
    ) -> models.MaintenanceEntry:
        return models.MaintenanceEntry(
            **self.client._request("put", f"/v1/maintenance/{id}", data=data.dict())
        )
...
class UsersClient:
    ...
    def change_password(self, data: models.ChangePassword):
        self.client._request("put", "/v1/users/change-password", data=data.dict())
    ...
    def register_new_user(self, data: models.UserRegistration):
        self.client._request("post", "/v1/users/register", data=data.dict())
    ...
    def update_account(self, data: models.UserUpdate) -> models.UserUpdate:
        return models.UserUpdate(
            **self.client._request("put", "/v1/users/self", data=data.dict())["item"]
        )
...
class LabelMakerClient:
    ...
    def get_asset_label(self, id: str, print: bool = None) -> str:
        params = {}
        if print:
            params["print"] = print
        return self.client._request("get", f"/v1/labelmaker/assets/{id}", params=params)

    def get_item_label(self, id: str, print: bool = None) -> str:
        params = {}
        if print:
            params["print"] = print
        return self.client._request("get", f"/v1/labelmaker/item/{id}", params=params)

    def get_location_label(self, id: str, print: bool = None) -> str:
        params = {}
        if print:
            params["print"] = print
...
class ProductsClient:
    ...
    def search_ean_from_barcode(self, data: str = None) -> list[models.BarcodeProduct]:
        params = {}
        if data:
            params["data"] = data
        return [
            ...
            for item in self.client._request(
                "get", "/v1/products/search-from-barcode", params=params
            )
        ]

    def create_qr_code(self, data: str = None) -> str:
        params = {}
        if data:
            params["data"] = data
